...
sub p_get
	{
	  ...
	  my $sql="SELECT template_id,COLLECTION_NAME,PLATE,ROW_POS,COL_POS,accession,mod_date,comment,sn,status,check_status,checker,check_date,mgc_status,placeno FROM _glz_mgc2gene WHERE gene_id = \'$gene_id\' ";
